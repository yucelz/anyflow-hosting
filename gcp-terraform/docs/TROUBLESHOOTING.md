...
gcloud container clusters get-credentials dev-n8n-cluster --zone=us-central1-a --project=anyflow-cloud
...
gcloud container clusters describe dev-n8n-cluster --zone=us-central1-a --project=anyflow-cloud
```
